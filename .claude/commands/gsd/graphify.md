...
**CJS-only (graphify):** `graphify` subcommands are not registered on `gsd-sdk query`. Use `node /Users/jarrettevans/Documents/Biomedical Data Science/Projects/Claude_Setup/.claude/get-shit-done/bin/gsd-tools.cjs graphify …` as documented in this command and in `docs/CLI-TOOLS.md`. Other tooling may still use `gsd-sdk query` where a handler exists.
...
Knowledge graph is disabled. To activate:
  ...
  node /Users/jarrettevans/Documents/Biomedical Data Science/Projects/Claude_Setup/.claude/get-shit-done/bin/gsd-tools.cjs config-set graphify.enabled true
...
```bash
node /Users/jarrettevans/Documents/Biomedical Data Science/Projects/Claude_Setup/.claude/get-shit-done/bin/gsd-tools.cjs graphify query <term>
```
...
```bash
node /Users/jarrettevans/Documents/Biomedical Data Science/Projects/Claude_Setup/.claude/get-shit-done/bin/gsd-tools.cjs graphify status
```
...
```bash
node /Users/jarrettevans/Documents/Biomedical Data Science/Projects/Claude_Setup/.claude/get-shit-done/bin/gsd-tools.cjs graphify diff
```
...
```
PREFLIGHT=$(node "/Users/jarrettevans/Documents/Biomedical Data Science/Projects/Claude_Setup/.claude/get-shit-done/bin/gsd-tools.cjs" graphify build)
```
...
Project root: ${CWD}
gsd-tools path: /Users/jarrettevans/Documents/Biomedical Data Science/Projects/Claude_Setup/.claude/get-shit-done/bin/gsd-tools.cjs
...
4. **Write diff snapshot:**
   ```
   node \"/Users/jarrettevans/Documents/Biomedical Data Science/Projects/Claude_Setup/.claude/get-shit-done/bin/gsd-tools.cjs\" graphify build snapshot
   ```
