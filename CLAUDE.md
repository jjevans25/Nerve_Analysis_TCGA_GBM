...
> **Path correction rule:** If any file, script, shebang, or config references `/Users/jarrettevans/Documents/Biomedical Data Science/Projects/CLAUDE_SETUP/`, replace that segment with `CLAUDE_TCGA_GBM`. The `CLAUDE_SETUP` path is stale and incorrect for this project.
